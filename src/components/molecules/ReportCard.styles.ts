...
export const styles = StyleSheet.create((theme) => ({
  ...
  row:        { paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.md, flexDirection: 'row', alignItems: 'center', gap: theme.spacing.lg },
  left:       { alignItems: 'center', gap: theme.spacing.xs, minWidth: 52 },
  catCount:   { fontSize: theme.typography.xs, fontWeight: '600', color: theme.colors.muted },
