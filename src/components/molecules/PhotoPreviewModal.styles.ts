...
export const styles = StyleSheet.create((theme, rt) => ({
  ...
  closeBtn:          { position: 'absolute', right: 16, top: rt.insets.top + 12, zIndex: 10, width: 48, height: 48, borderRadius: 24, backgroundColor: 'rgba(255,255,255,0.15)', justifyContent: 'center', alignItems: 'center' },
