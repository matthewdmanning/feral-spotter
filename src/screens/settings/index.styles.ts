...
export const styles = StyleSheet.create((theme, rt) => ({
  ...
  inner:                { gap: theme.spacing.lg, paddingBottom: theme.spacing.xxl, width: '100%', alignSelf: 'center', maxWidth: { xs: '100%', md: 640 } },
  ...
  linkRow:              { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: theme.spacing.sm, paddingVertical: 4 },
  ...
  footerBtn:            { minHeight: 48, justifyContent: 'center', flex: 1, alignItems: 'center', paddingVertical: 12, borderRadius: theme.radius.md },
