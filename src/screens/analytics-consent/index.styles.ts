...
export const styles = StyleSheet.create((theme) => ({
  ...
  continueBtn:  { minHeight: 48, justifyContent: 'center', backgroundColor: theme.colors.accent, borderRadius: theme.radius.lg, paddingVertical: 15, alignItems: 'center', marginTop: theme.spacing.xl },
