...
export const styles = StyleSheet.create((theme) => ({
  ...
  locationHelpToggle:     { flexDirection: 'row', alignItems: 'center', gap: theme.spacing.xs, marginTop: -theme.spacing.sm },
  locationHelpToggleText: { color: theme.colors.muted, fontSize: theme.typography.xs },
  locationHelpText:       { color: theme.colors.muted, fontSize: theme.typography.xs, lineHeight: theme.typography.sm * 1.4 },
