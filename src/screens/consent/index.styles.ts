...
export const styles = StyleSheet.create((theme) => ({
  ...
  item:       { color: theme.colors.text, fontSize: theme.typography.base, lineHeight: 22, marginBottom: theme.spacing.xs, marginLeft: theme.spacing.md, flexShrink: 1 },
  itemLabel:  { fontWeight: '700' },
  analyticsRow:     { flexDirection: 'row', alignItems: 'flex-start', gap: theme.spacing.sm, marginBottom: theme.spacing.xs },
  analyticsItemText:{ marginLeft: 0, marginBottom: 0 },
