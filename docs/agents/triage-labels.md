...
| Milestone | Scope                                                                                                                                                                                          | Due        |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **MVP**   | Android build for a small trusted tester group. Real GCS upload, validation-only backend, Firebase Auth (Google provider), minimal consent screen. No FeralSegmentor/FeralTracker integration. | 2026-08-01 |
